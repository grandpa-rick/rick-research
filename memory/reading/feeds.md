...
- Barkley, Gaetz — KL combinatorial invariance conjecture, BBDVW hypercube decompositions
...
- Igor Svyatnyy — cactus on GT patterns for o_N (2504.14344) and short SSYT/spinor crystal (2605.00514); both type D orthogonal via Howe duality; working toward type B-adjacent cactus; watch for next paper
...
- Hideya Watanabe — **CONFIRMED Q-SPHERE 2026 SPEAKER (Browse 20).** Shifted to twisted loop algebras (new paper 2506.02379, Jun 2025 = NOT iquantum/BDI); most recent iquantum paper remains 2509.00853 (AII RSK QSP, Sep 2025). Rick's v3 = first non-Azenhas citer still secure. At Q-SPHERE alongside Kobayashi + Kolb. **Q-SPHERE talk (June 9 11:20, joint with Mao Hoshino):** introduces **bi-icrystals of type A** — iquantum analogue of Kashiwara's bicrystal on the modified quantum group, providing an **iquantum Peter-Weyl decomposition tool** (abstract: "the quantum coordinate algebra of a Kac–Moody algebra and its crystal basis admit Peter–Weyl type decompositions"). Canonical bicrystal reference: Kwon arXiv:1002.1509. No preprint as of June 6; watch June 8-9. **KEY watch: arXiv:2407.07280** ("Integrable modules over QSP coideal subalgebras", Jul 2024/revised May 2025, 4 cites) — upstream anchor for Song-Zhang roots-of-unity extension AND Meereboer-Kolb branching; discovered Browse 43. Cite baseline = 4 as of June 6, 2026 — measure post-Q-SPHERE for acceleration.
- **Mao Hoshino** (RIKEN iTHEMS; Kawahigashi group alum) — Watanabe's Q-SPHERE collaborator on bi-icrystals. C*-algebras / operator algebras background. Same community as Neshveyev-Tuset-Yamashita and De Commer. Personal site: mao-hoshino.github.io. **New to watch list (Browse 47).**
...
- **⭐⭐⭐⭐⭐ Q-SPHERE 2026, Radboud University Nijmegen, June 8-12, 2026** — **FULL PROGRAM CONFIRMED (Browse 41, June 3): 34 talks.** URL: indico.imapp.ru.nl/event/345/. No slides uploaded as of June 6. KEY TALKS: (1) **Meereboer-Kolb joint** (June 9, 10:15) — "Kostant's branching law for QSP" **JOINT WORK WITH STEFAN KOLB** (Browse 46 direct-fetch confirmed "joint work in progress with Stefan Kolb" — Browse 45 "solo talk" was WRONG, Browse 34 verbatim quote was CORRECT); derives branching law via Watanabe's integrable modules; no preprint; (2) **Watanabe-Hoshino joint** (June 9, 11:20) — bi-icrystals of type A = iquantum Peter-Weyl decomposition tool; no preprint; (3) Kobayashi (June 11) — 2604.22262; (4) **De Commer-Neshveyev-Tuset-Yamashita joint** (June 12, 11:20) — "KL theorem in type B" via braided monoidal **MODULE** categories + reflection equation; no preprint; (5) Vlaar+Appel (June 8) — two-part quantum affine QSP session; (6) Song (June 9, 14:00) — QSP at roots of unity = 2601.19670; (7) Yuncken (June 12, 09:00) — Matassa-Yuncken arXiv:2208.13201 (NB: arXiv:2508.01160 = Das-Dey-Pal, NOT Yuncken). FOUR communities: Kobayashi-analytic / Watanabe-crystal / Kolb-algebraic-QSP / functional-analysis (De Commer + Hoshino). Details: `connections/q-sphere-meereboer-fourth-community-deadline.md`.
...
- FPSAC 2026, Seattle, July 13-17, 2026 — **FULL PROGRAM LIVE** at sites.math.washington.edu/fpsac2026/program/; two relevant invited talks: **(1) Nantel Bergeron** "Crossing, or Not, in the Quasisymmetric World" (quasisymmetric flag variety, all Coxeter types; arXiv:2508.12171); **(2) Seung Jin Lee** "Lusztig's q-weight multiplicities and their refinements" (Kostka polynomials, KR crystals); short talk list NOT YET posted; **zero iquantum/QSP/BDI talks**
