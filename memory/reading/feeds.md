...
- Hideya Watanabe — **AFFILIATION CORRECTION (Browse 59):** Q-SPHERE Indico lists Watanabe at Rikkyo University, Tokyo (not RIKEN iTHEMS as previously recorded). Q-SPHERE talk (June 9): "Quantizations of coordinate algebras of symmetric pair subalgebras." Bi-icrystal paper expected with Hoshino; no preprint as of June 13. Most recent iquantum paper: arXiv:2502.07270 (Naito-Suzuki-Watanabe, published J. Algebra April 2026). **KEY watch: arXiv:2407.07280** (5 cites as of Browse 59, June 13). Rick's v3 = first non-Azenhas/Meereboer citer still secure. Watch for Watanabe-Hoshino bi-icrystal preprint June-August 2026.
...
- **Toshiyuki Kobayashi** — arXiv:2604.22262 "Stability of Branching Multiplicities for Orthogonal Gelfand Pairs" (2026); proves branching multiplicities locally constant on convex regions with "fences" (hyperplane walls) for (o(n+1),o(n)) = BDI pairs. **OQ-KOBAYASHI-FENCES-BDI: do his fences match Rick's {m₂=0},{m₂₃₆=0},{m₂₃₄₅₆=0} walls? HIGH PRIORITY READ.** Fence conditions = ξᵢ + δνⱼ = ±½ on infinitesimal characters. GL(n)→O(n)×O(n) extension **explicitly deferred** — Rick is doing this. **CORRECTION (Browse 58):** arXiv:2509.17007 is Harris-Kobayashi-Speh "Translation functors + Shimura varieties" — UNRELATED to stability regions. The actual "Stability region" preprint is 6 pages, NO arXiv ID, on Kobayashi's Tokyo webpage (https://www.ms.u-tokyo.ac.jp/~toshi/pub/tk2026b.html), covers only (gl(n+1),gl(n)) and (o(n+1),o(n)) — NOT AII→BDI. **Scenario B confirmed: Rick's GL(n)→O(n)×O(n) case is the deferred case, not yet in any Kobayashi paper.**
...
- **Lucas Meereboer** — arXiv:2510.17655 "Iota crystal theory for 1-dimensional modules" (Oct 2025); foundational paper for iota (iquantum) crystal theory. Cited by Watanabe 2407.07280. Precursor to Meereboer-Kolb joint work "Kostant's branching law for QSP" (announced Q-SPHERE June 9 — no preprint yet). Skim intro for BDI icrystal foundations. **NEW Browse 59.**
